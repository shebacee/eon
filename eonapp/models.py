...
class online_book(models.Model):
    ...
    content=models.TextField(max_length=3000,default=1)
    emotion=models.TextField(max_length=1000,default="Happy")
...
class cust_thoughtwaves(models.Model):
    ...
    content=models.TextField(max_length=20000, default=1)
    CUSTOMER=models.ForeignKey(customer,default=1,on_delete=models.CASCADE)
    category=models.TextField(max_length=20000, default=1)
