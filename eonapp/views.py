...
static_path=r"/home/sbcvmbox/Desktop/eon_final/eon/eonapp/static/"
...
def login_post(request):
    ...
    if image_data:
        ...
        image_path = os.path.join(r"/home/sbcvmbox/Desktop/eon_final/eon/", f'{un}_login_image.png')
...
def onlinebookadd_post(request):
    ...
    # fs = FileSystemStorage()
    d = datetime.datetime.now().strftime("%Y%m%d-%H%M%S")
    fs.save(r"/home/sbcvmbox/Desktop/eon_final/eon/eonapp/static/certificate/"+d+".pdf", book_content)
...
def reg_seller_post(request):
    ...
    filename = f"certificate/{d}.pdf"
    fs.save(filename, cert)
    path = f"/static/certificate/{d}.pdf"


    # fs.save(r"/home/sbcvmbox/Desktop/eon_final/eon/eonapp/static/certificate/" +d+ ".pdf",cert)
...
def add_mythoughtwaves_post(request):
    ...
    fs = FileSystemStorage()
    d = datetime.datetime.now().strftime("%Y%m%d-%H%M%S")
    fs.save(r"/home/sbcvmbox/Desktop/eon_final/eon/eonapp/static/image/" + d + ".jpg", image1)
    path = "/static/image/" + d + ".jpg"
...
# #         image = request.FILES['image']
# #         upload_path = os.path.join(r"/home/sbcvmbox/Desktop/eon_final/eon/", 'captures')
...
#     res=""
#     if ok:
#         cv2.imwrite(r"/home/sbcvmbox/Desktop/eon_final/eon/captures/webcam_capture.png", frame)
#         em=emotion()
#         print(em)
#         cam.release()
...
#
#     model.load_weights(r'/home/sbcvmbox/Desktop/eon_final/eon/eonapp/static/model.h5')
#
...
#                     6: "Surprised"}
#
#     frame = cv2.imread( r"/home/sbcvmbox/Desktop/eon_final/eon/captures/webcam_capture.png")
#
#     facecasc = cv2.CascadeClassifier(r'/home/sbcvmbox/Desktop/eon_final/eon/eonapp/static/haarcascade_frontalface_default.xml')
...
#     model_path = r'/home/sbcvmbox/Desktop/eon_final/eon/eonapp/static/model.h5'
...
#     haar_cascade_path = r'/home/sbcvmbox/Desktop/eon_final/eon/eonapp/static/haarcascade_frontalface_default.xml'
#     if not os.path.exists(haar_cascade_path):
#         raise FileNotFoundError(f"Haar Cascade XML file not found at: {haar_cascade_path}")
#     face_cascade = cv2.CascadeClassifier(haar_cascade_path)
#
#     # Input image path
#     image_path = r"/home/sbcvmbox/Desktop/eon_final/eon/captures/webcam_capture.png"
